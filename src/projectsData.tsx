...
export const projects = [
  ...
  },
  {
    ...
    bullets: ["• Javascript", "• Vite", "• Three.js", "• Vercel"],
    stack: {
      lang: {
        name: "Javascript",
        icon: <CustomIcon svg="/typescript.svg" />,
