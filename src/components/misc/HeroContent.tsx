...
const HeroContent = () => {
  return (
    <div className="flex flex-col gap-4 justify-start items-start lg:w-full z-10">
      <Typography color="primary" variant="h6" fontFamily="lato">
        Hi, I am Mike Lautensack
      </Typography>
      <Typography color="primary" variant="h2" fontFamily="lato">
        I am full-stack SaaS developer
      </Typography>
      <Typography color="primary" variant="body1" fontFamily="lato">
